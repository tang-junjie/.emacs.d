...
(custom-theme-set-faces
 ...
 '(org-block-begin-line ((t (:underline "#a7a6aa" :foreground "#008ed1" :background "#102e4e"))))
 '(org-block-background ((t (:background "#0f0f0f"))))
 '(org-block-end-line ((t (:overline "#a7a6aa" :foreground "#008ed1" :background "#102e4e"))))
